...
if &background ==# 'dark'
  ...
  hi Underlined ctermfg=108 ctermbg=NONE guifg=#7f9d77 guibg=NONE guisp=NONE cterm=NONE,underline gui=NONE,underline
  ...
  hi Error ctermfg=236 ctermbg=138 guifg=#242f3a guibg=#bb897d guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi Delimiter ctermfg=179 ctermbg=NONE guifg=#e2bd67 guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
