...
function size_window (xid, operation)
    os.execute(os.getenv("HOME").."/bin/xmat.py --xid "..xid.." "..operation)
end
...
-- * https://github.com/BurntSushi/pytyle3/blob/8a1ca4189659a4fd2250eb8c2166b630210e8eae/pt3/client.py#L257
transient = get_window_property('WM_TRANSIENT_FOR')
if (transient ~= '' or
        string.match(n, "scratchpad") or
        string.match(t, "WINDOW_TYPE_COMBO") or
        string.match(t, "WINDOW_TYPE_DESKTOP") or
        string.match(t, "WINDOW_TYPE_DIALOG") or
        string.match(t, "WINDOW_TYPE_DND") or
        string.match(t, "WINDOW_TYPE_DOCK") or
        string.match(t, "WINDOW_TYPE_DROPDOWN_MENU") or
        string.match(t, "WINDOW_TYPE_MENU") or
        string.match(t, "WINDOW_TYPE_NOTIFICATION") or
        string.match(t, "WINDOW_TYPE_POPUP_MENU") or
        string.match(t, "WINDOW_TYPE_TOOLBAR") or
        string.match(t, "WINDOW_TYPE_TOOLTIP") or
