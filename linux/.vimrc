...
let g:vim_markdown_fenced_languages = ['bash', 'c', 'cpp', 'diff', 'html', 'java', 'javascript', 'json', 'lua', 'ps1', 'python', 'rust', 'sh', 'toml', 'yaml', 'batch=dosbatch', 'bat=dosbatch', 'js=javascript', 'powershell=ps1']
