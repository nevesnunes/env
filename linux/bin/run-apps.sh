...
run_app "user-terminal.sh 'tmux source-file ~/.local/share/tmux/sessions/tasks'" 1 -l
run_app "user-terminal.sh 'tmux source-file ~/.local/share/tmux/sessions/main'" 2 -h
run_app "user-terminal.sh 'tmux source-file ~/.local/share/tmux/sessions/ctf'" 2 -l
