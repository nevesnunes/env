...
run_app "user-terminal.sh 'tmux new-session -s tasks \; source-file ~/.local/share/tmux/sessions/tasks'" 1 -l
run_app "user-terminal.sh 'tmux new-session -s main \; source-file ~/.local/share/tmux/sessions/main'" 2 -l
run_app "user-terminal.sh 'tmux new-session -s ctf \; source-file ~/.local/share/tmux/sessions/ctf'" 2 -l
