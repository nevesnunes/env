...
hi Boolean   guifg=#7f63b5 guibg=NONE gui=bold ctermbg=NONE ctermfg=5 cterm=bold
hi Character guifg=#7f63b5 guibg=NONE gui=bold ctermbg=NONE ctermfg=5 cterm=bold
hi Constant  guifg=#7f63b5 guibg=NONE gui=bold ctermbg=NONE ctermfg=5 cterm=bold
hi Float     guifg=#7f63b5 guibg=NONE gui=bold ctermbg=NONE ctermfg=5 cterm=bold
hi Number    guifg=#7f63b5 guibg=NONE gui=bold ctermbg=NONE ctermfg=5 cterm=bold
hi String    guifg=#115c5a guibg=NONE gui=NONE ctermbg=NONE ctermfg=5

hi Function   guifg=#1f8865 guibg=NONE gui=NONE ctermbg=NONE ctermfg=2
hi Identifier guifg=#1f8865 guibg=NONE gui=bold ctermbg=NONE ctermfg=2 cterm=bold
...
hi Define    guifg=#a62835 guibg=NONE gui=NONE ctermbg=NONE ctermfg=4
hi Include   guifg=#a62835 guibg=NONE gui=NONE ctermbg=NONE ctermfg=4
hi Macro     guifg=#a62835 guibg=NONE gui=NONE ctermbg=NONE ctermfg=4
hi PreCondit guifg=#a62835 guibg=NONE gui=NONE ctermbg=NONE ctermfg=4
hi PreProc   guifg=#a62835 guibg=NONE gui=NONE ctermbg=NONE ctermfg=4
...
hi Type         guifg=#a62835 guibg=NONE gui=bold ctermbg=NONE ctermfg=6 cterm=bold
hi Typedef      guifg=#a62835 guibg=NONE gui=NONE ctermbg=NONE ctermfg=6

hi Comment        guifg=#1f8865 guibg=NONE gui=italic ctermbg=NONE ctermfg=2 cterm=NONE
hi Debug          guifg=#1f8865 guibg=NONE gui=NONE   ctermbg=NONE ctermfg=6
hi Delimiter      guifg=#1f8865 guibg=NONE gui=NONE   ctermbg=NONE ctermfg=6
...
hi Tag            guifg=#1f8865 guibg=NONE gui=NONE   ctermbg=NONE ctermfg=6
hi Todo           guifg=#1f8865 guibg=NONE gui=italic ctermbg=NONE ctermfg=6 cterm=NONE

hi Error      guifg=#a62835 guibg=NONE gui=bold           ctermbg=NONE ctermfg=9 cterm=bold
hi Ignore     guifg=#286d8a guibg=NONE gui=italic         ctermbg=NONE ctermfg=4 cterm=NONE
...
hi NonText    guifg=#286d8a guibg=NONE gui=NONE ctermbg=NONE ctermfg=4
...
hi VisualNOS guifg=#ffffff guibg=#286d8a gui=NONE ctermbg=4 ctermfg=white

hi Cursor       guifg=#ffffff guibg=#286d8a gui=NONE ctermbg=4     ctermfg=white
...
hi VertSplit    guifg=#286d8a guibg=#286d8a gui=bold ctermbg=8     ctermfg=8     cterm=bold
hi Folded       guifg=#286d8a guibg=#d7e0ec gui=NONE ctermbg=NONE  ctermfg=white
hi FoldColumn   guifg=#286d8a guibg=#d7e0ec gui=NONE ctermbg=NONE  ctermfg=white
hi IncSearch    guifg=#ffffff guibg=#c5535a gui=NONE ctermbg=white ctermfg=0     cterm=bold
hi LineNr       guifg=#286d8a guibg=#d7e0ec gui=NONE ctermbg=NONE  ctermfg=8     cterm=NONE
...
hi ErrorMsg     guifg=#ffffff guibg=#a62835 gui=NONE ctermbg=1     ctermfg=black
...
hi StatusLine   guifg=#d7e0ec guibg=#286d8a gui=bold ctermbg=8    ctermfg=black cterm=bold
hi StatusLineNC guifg=#8cc3ca guibg=#286d8a gui=bold ctermbg=8    ctermfg=3     cterm=bold
hi TabLineFill  guifg=#d7e0ec guibg=#286d8a gui=bold ctermbg=4    ctermfg=black cterm=bold
hi TabLine      guifg=#d7e0ec guibg=#286d8a gui=bold ctermbg=4    ctermfg=black cterm=bold
...
hi PMenuSbar  guifg=#d7e0ec guibg=#286d8a gui=NONE   ctermbg=8    ctermfg=white
hi PMenuSel   guifg=#ffffff guibg=#c5535a gui=bold   ctermbg=4    ctermfg=black
hi PMenu      guifg=#d7e0ec guibg=#286d8a gui=bold   ctermbg=0    ctermfg=3
hi PMenuThumb guifg=#286d8a guibg=#8cc3ca gui=NONE   ctermbg=NONE ctermfg=white
...
hi preproc           guifg=#7f63b5 guibg=NONE    gui=NONE ctermbg=NONE  ctermfg=5

hi SignColumn guifg=#286d8a guibg=#d7e0ec gui=bold ctermbg=NONE ctermfg=3 cterm=bold
...
if (!empty($NO_COLOR) || empty($COLORTERM) || match('linux', $TERM) != -1 || match('dumb', $TERM) != -1)
    ...
    hi DiffDelete guifg=white guibg=#a62835 gui=bold,nocombine ctermbg=9     ctermfg=black cterm=bold,nocombine
    hi DiffText   guifg=white guibg=#7f63b5 gui=bold,nocombine ctermbg=white ctermfg=black cterm=bold,nocombine
else
    ...
    hi DiffDelete guifg=white guibg=#a62835 gui=bold,nocombine ctermbg=210   ctermfg=black cterm=bold,nocombine
    hi DiffText   guifg=white guibg=#7f63b5 gui=bold,nocombine ctermbg=96    ctermfg=black cterm=bold,nocombine
endif
...
hi ALEWarning     guifg=#7f63b5 guibg=NONE gui=bold,underline,nocombine ctermbg=black ctermfg=blue cterm=bold,underline,nocombine
